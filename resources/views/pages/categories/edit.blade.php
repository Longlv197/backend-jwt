                ...
                @if ($categories)
                    ...
                    <div class="col-md-5 mr-3" id="category-create-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" value={{ $category->categoryName }} placeholder="Tên danh mục">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                                ...
                                <div class="status-group" id="status-group">
                                    <div class="form-check">
                                        <label class="form-check-label" for="status-public">
                                            <input type="radio" class="form-check-input" name="status" id="status-public" value="1" checked>
                                            <span>Public</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                            ...
                            @else
                                <div class="status-group" id="status-group">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label" for="status-private">
                                            <input type="radio" class="form-check-input" name="status" id="status-private" value="2" checked>
                                            <span>Private</span>
                                        </label>
                                    </div>
                                </div>
